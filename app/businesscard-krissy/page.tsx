...
/**
 * Director of Marketing & Corporate Strategy digital business card.
...
const card = {
  ...
  profilePhoto: "/krissy-profile.jpg",
  backgroundPhoto: "/krissy-profile-background.jpg",
  ...
  contact: {
    phone: "905-709-7911 Ext. 2237",
    tollFree: "1-888-539-4246",
    email: "ksukhraj@keybase.com",
    website: "www.keybase.com",
  },
  primaryCta: {
    label: "Book a Meeting",
    href: "https://cal.com/stylecast-uurjw6/business-chat-with-krissy-sukhraj",
  },
} as const;
...
export default function BusinessCardKrissyPage() {
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 -bottom-12 h-24 w-24 -translate-x-1/2 overflow-hidden rounded-full bg-white shadow-lg ring-4 ring-white sm:-bottom-16 sm:h-32 sm:w-32">
          <Image
            ...
            className="object-cover"
            style={{ objectPosition: "50% 25%", transform: "scale(1.6)" }}
          />
        </div>
      </div>
