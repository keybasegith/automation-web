...
import {
  getPublishedCareers,
  getVisiblePublishedRoles,
} from "@/lib/cms/public";
import { pageMetadata } from "@/lib/seo/metadata";

export async function generateMetadata() {
  return pageMetadata("/careers", "Careers — Keybase Financial Group", "Build your career at Keybase Financial Group — an independent, Canadian-owned advisory firm. Explore open roles across advisory, compliance, operations, and more, and apply today.");
}

export default async function CareersPage() {
  const [{ hero }, roles] = await Promise.all([
    getPublishedCareers(),
    getVisiblePublishedRoles(),
  ]);
  return (
