...
export const metadata = {
  title: "First Home Savings Account (FHSA) — Keybase Financial Group",
  description:
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          >
            ...
            <ChevronRight className="h-3.5 w-3.5 text-white/40" />
            <span className="text-white">First Home Savings Account (FHSA)</span>
          </nav>
          ...
          >
            A First Home Savings Account (FHSA) is a registered savings plan
            designed to help eligible first-time home buyers save for a qualifying
            home in Canada.
          </p>
          <div className="mt-10">
            <Link
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          <Reveal className="max-w-3xl">
            <h2
              ...
              style={{ textShadow: "0 2px 28px rgba(0,0,0,0.5)" }}
            >
              Take the First Step Toward Home
            </h2>
            <p
              className="mt-6 max-w-2xl text-lg leading-relaxed text-white/85"
              style={{ textShadow: "0 1px 16px rgba(0,0,0,0.5)" }}
            >
              An FHSA can be one of the most tax-efficient ways to save for your
              first home. Speak with a Keybase Financial Advisor to see how it fits
