...
export const metadata = pageMetadata("/become-an-advisor", "Become an Advisor — Keybase Financial Group", "Grow your practice with Keybase Financial Group. Join an independent, Canadian-owned firm with the platform, products, and support to help advisors and their clients thrive. Tell us about your business to get started.");
...
export default function BecomeAdvisorPage() {
  return (
    <div className="font-franklin min-h-screen bg-white text-[#1a2433]">
      <SiteHeader />
      <BreadcrumbSchema items={[{ name: "Become an Advisor", path: "/become-an-advisor" }]} />
