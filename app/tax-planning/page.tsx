...
export const metadata = {
  title: "Tax Planning — Keybase Financial Group",
  description:
    ...
    <div className="font-franklin min-h-screen bg-white text-[#1a2433]">
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 pb-20 pt-28 sm:px-8 sm:pb-28 sm:pt-40">
          ...
          >
            Tax-efficient investing is a critical part of building and preserving
            wealth. Keybase helps structure your investments with tax efficiency
            in mind — so unnecessary taxes never quietly erode your long-term
            returns.
          </p>
          <div className="mt-10">
            <Link
