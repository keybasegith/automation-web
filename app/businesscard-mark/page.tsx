...
/**
 * Chief Compliance Officer digital business card.
...
const card = {
  ...
  profilePhoto: "/mark-profile.jpg",
  backgroundPhoto: "/mark-profile-background.jpg",
  ...
  contact: {
    phone: "905-709-7911 Ext. 2255",
    fax: "905-709-7022",
    email: "mark.garcia@keybase.com",
...
export default function BusinessCardMarkPage() {
      ...
      <div className="px-5 pt-16 pb-5 sm:px-7 sm:pt-20 sm:pb-7">
        ...
        <div className="mt-4 space-y-0.5 text-center text-[11px] leading-snug text-slate-600 sm:mt-5 sm:space-y-1 sm:text-[13px]">
          <p>
            ...
            <span className="text-slate-400">F:</span> {card.contact.fax}
          </p>
          <p>
