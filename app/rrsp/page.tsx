...
export const metadata = {
  title: "Registered Retirement Savings Plan (RRSP) — Keybase Financial Group",
  description:
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          >
            ...
            <ChevronRight className="h-3.5 w-3.5 text-white/40" />
            <span className="text-white">Registered Retirement Savings Plan (RRSP)</span>
          </nav>
          ...
          >
            Save for retirement, save on taxes today.
          </h1>
          <p
            className="mt-7 max-w-2xl text-lg leading-relaxed text-white/85"
            style={{ textShadow: "0 1px 16px rgba(0,0,0,0.5)" }}
          >
            A Registered Retirement Savings Plan (RRSP) is a registered investment
            account designed to help Canadians save for retirement while reducing
