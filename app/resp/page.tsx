...
export const metadata = {
  title: "Registered Education Savings Plan (RESP) — Keybase Financial Group",
  description:
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          >
            ...
            <ChevronRight className="h-3.5 w-3.5 text-white/40" />
            <span className="text-white">Registered Education Savings Plan (RESP)</span>
          </nav>
          ...
          >
            ...
            plan designed to help parents, grandparents, family members, and
            friends save for a child&rsquo;s future education.
          </p>
          <div className="mt-10">
            <Link
              href="/contact"
