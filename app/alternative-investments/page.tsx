...
export const metadata = {
  title: "Alternative Investments — Keybase Financial Group",
  description:
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          >
            ...
            <ChevronRight className="h-3.5 w-3.5 text-white/40" />
            <span className="text-white">Alternative Investments</span>
          </nav>
          ...
          >
            Alternative investments reach beyond traditional asset classes like
            publicly traded stocks, bonds, and cash. For qualified investors, they
            can play a valuable role in portfolio diversification and long-term
            wealth planning.
          </p>
          <div className="mt-10">
            <Link
