...
export const metadata = {
  title: "Estate Planning — Keybase Financial Group",
  description:
    ...
    <div className="font-franklin min-h-screen bg-white text-[#1a2433]">
      ...
      <section className="relative overflow-hidden border-b border-black/10 bg-[#0a1f33] text-white">
        ...
        <div className="relative mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          >
            Protect what you&rsquo;ve built. Pass it on with purpose.
          </h1>
          <p
            className="mt-7 max-w-2xl text-lg leading-relaxed text-white/85"
            style={{ textShadow: "0 1px 16px rgba(0,0,0,0.5)" }}
          >
            A thoughtful estate plan brings clarity to one of life&rsquo;s most
            important decisions — how your wealth, care, and legacy are handled.
            Keybase helps you protect your assets and transfer them seamlessly
            across generations.
          </p>
          <div className="mt-10">
            <Link
