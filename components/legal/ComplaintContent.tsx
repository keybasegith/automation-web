...
export default function ComplaintContent() { return <div className="space-y-6 leading-relaxed">
      <p>
      ...
      <div>
        <h2 className={heading}>The Client Complaint Information Form</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>Complaint Handling Procedures</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>Settlements</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>Contacting Keybase Financial Group Inc.</h2>
        <p className="mt-2">
