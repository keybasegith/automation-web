...
export default function PrivacyPolicyContent() { return <div className="space-y-6 leading-relaxed">
      <div>
        <h2 className={heading}>Things you should know</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>Protecting Privacy</h2>
      ...
      <div>
        <h2 className={heading}>Our Principles</h2>
      ...
      <div>
        <h2 className={heading}>Concerns</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>1. What is personal information?</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>2. Why we ask for your personal information?</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>5. Will you be able to withdrawal consent?</h2>
        <p className="mt-2">
      ...
      <div>
        <h2 className={heading}>Privacy and Personal Information</h2>
        <p className="mt-2">
