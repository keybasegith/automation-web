...
/**
 * The resp page body — every section below the hero.
 *
 * Lives apart from the route so both the standalone /resp page and the
 * tabbed /services/resp view render exactly the same content.
 */
export default function RespBody() {
  return (
    <>
      {/* ---------- Overview ---------- */}
