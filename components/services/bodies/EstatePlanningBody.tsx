...
/**
 * The estate-planning page body — every section below the hero.
 *
 * Lives apart from the route so both the standalone /estate-planning page and the
 * tabbed /services/estate-planning view render exactly the same content.
 */
export default function EstatePlanningBody() {
  return (
    <>
