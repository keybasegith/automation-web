...
/**
 * The non-registered-investments page body — every section below the hero.
 *
 * Lives apart from the route so both the standalone /non-registered-investments page and the
 * tabbed /services/non-registered-investments view render exactly the same content.
 */
export default function NonRegisteredInvestmentsBody() {
  return (
    <>
      {/* ---------- Overview ---------- */}
