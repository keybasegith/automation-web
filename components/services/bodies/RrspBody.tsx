...
/**
 * The rrsp page body — every section below the hero.
 *
 * Lives apart from the route so both the standalone /rrsp page and the
 * tabbed /services/rrsp view render exactly the same content.
 */
export default function RrspBody() {
  return (
    <>
      {/* ---------- Overview ---------- */}
